...
var Customizator = /*#__PURE__*/function () {
  ...
  _createClass(Customizator, [{
        ...
        elem.childNodes.forEach(function (item) {
          if (item.nodeName === '#text' && item.nodeValue.replace(/\s+/g, '').length > 0) {
            if (!item.parentNode.getAttribute('data-fs')) {
              ...
              item.parentNode.style.fontSize = item.parentNode.getAttribute('data-fs') * _this2.scale + 'px';
            } else item.parentNode.style.fontSize = item.parentNode.getAttribute('data-fs') * _this2.scale + 'px';
          } else recursy(item);
        });
      };

      recursy(this.body); // LOCAL STORAGE
    ...
    value: function onColorChange(event) {
      this.body.style.backgroundColor = event.target.value; // LOCAL STORAGE
    ...
    value: function render() {
      ...
      var scaleInputSmall = document.createElement('input'),
          ...
          panel = document.createElement('div'); // HTML

      this.clear.innerHTML = "&times"; // Classes
      ...
      scaleInputMedium.classList.add('scale_btn'); // Attributes
      ...
      scaleInputMedium.setAttribute('value', '1.5x'); // Rendering
